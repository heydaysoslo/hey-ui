...
var StyledBurger = styled.span(function (_ref) {
  ...
  return css(_templateObject(), width, height, width, height, thickness, theme.colors.text, easeIn, thickness / 2, height / 2 - thickness / 2, easeIn, height / 2 - thickness / 2, active && css(_templateObject2(), easeOut, easeOut));
});
...
var Wrapper = styled.button(function (_ref2) {
  var _t$radius;

  var t = _ref2.theme,
      modifiers = _ref2.modifiers;
  return css(_templateObject$1(), t.colors.text, t.colors.background, modifiers && !modifiers.includes('small') && t.fonts.body(), ((_t$radius = t.radius) === null || _t$radius === void 0 ? void 0 : _t$radius.normal) || '0px', t.colors.background, t.colors.text, applyModifier('small', css(_templateObject2$1(), t.fonts.small())), applyModifier('full', css(_templateObject3())));
});
...
var Spacer = styled.div(function (_ref) {
  var theme = _ref.theme,
      _ref$size = _ref.size,
      size = _ref$size === void 0 ? 'md' : _ref$size,
      custom = _ref.custom;
  return css(_templateObject$3(), !custom && theme.spacing[size]('size'), custom && css(_templateObject2$2(), custom, custom));
});
...
var Stack$1 = styled(Stack)(function (_ref2) {
  ...
  return css(_templateObject$4(), direction, reverse ? css(_templateObject2$3(), direction) : css(_templateObject3$1(), direction));
});
...
var Sticky = styled.div(function (_ref) {
  var theme = _ref.theme,
      _ref$top = _ref.top,
      top = _ref$top === void 0 ? '0px' : _ref$top,
      _ref$from = _ref.from,
      from = _ref$from === void 0 ? 'xs' : _ref$from;
  return css(_templateObject$5(), theme.bp[from], top ? css(_templateObject2$4(), top) : css(_templateObject3$2()));
});
...
var StyledSwitch = styled.button(function (_ref2) {
